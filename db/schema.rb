...
ActiveRecord::Schema.define(version: 20141118184616) do
  ...
  create_table "projects", force: true do |t|
    ...
    t.string   "project_bg_colour",   default: "f9ec31", null: false
    t.string   "project_text_colour", default: "333",    null: false
