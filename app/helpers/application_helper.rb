module ApplicationHelper
  ...
  def pixelache_format(text, html_options = {}, options = {})
    ...
    text = sanitize(text, tags: %w{a bold img b div strong iframe italic h1 h2 h3 h4 h5 h6 b i em br p}, attr: %w{href src width class id align height}) unless options[:sanitize] == false
    text = text.to_str
    text.gsub!(/\r\n?/, "\n") # \r\n and \r -> \n
    text.gsub!(/([^\n]\n)(?=[^\n])/, '\1<br />') # 1 newline -> br
    text.html_safe
