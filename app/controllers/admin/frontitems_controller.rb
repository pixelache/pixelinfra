class Admin::FrontitemsController < Admin::BaseController
  ...
  def permitted_params
    params.permit(:frontitem => [:item_type, :subsite_id, :seconditem_type, :seconditem_id, :custom_title, :item_id, :frontmodule_id, :position, :external_url, :remove_bigimage, :background_colour, :bigimage, :text_colour, :active])
